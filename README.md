...
dependencies {
    compile 'com.github.softwareberg.rinca:database:0.11.0'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:httpclient:0.11.0'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:xml:0.11.0'
}
```
