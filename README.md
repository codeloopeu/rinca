...
dependencies {
    compile 'com.github.softwareberg.rinca:database:0.9.1'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:httpclient:0.9.1'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:json:0.9.1'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:xml:0.9.1'
}
```
