...
dependencies {
    compile 'com.github.softwareberg.rinca:database:0.7.2'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:httpclient:0.7.2'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:json:0.7.2'
}
```
...
dependencies {
    compile 'com.github.softwareberg.rinca:xml:0.7.2'
}
```
